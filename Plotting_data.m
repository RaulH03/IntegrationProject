...
ylabel('Torque / Input', 'FontWeight', 'bold');
...
hold off;
ylim([-1, 1]);
ylabel('Link 1 Angle', 'FontWeight', 'bold');
...
hold off;
ylim([-0.1, 0.1]);
ylabel('Link 2 Angle', 'FontWeight', 'bold');
...
ylabel('Angular Vel', 'FontWeight', 'bold');
legend('Est Velocity 1', 'Est Velocity 2', 'Location', 'northeast');
grid on;

% Add overall title
sgtitle('Double Pendulum MPC: Up-Up Equilibrium Hold', 'FontSize', 15, 'FontWeight', 'bold');